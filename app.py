...
.rp-panel { background:var(--bg3); border:1px solid var(--border); border-radius:8px; overflow:hidden; margin-bottom:14px; }
.rp-panel-hdr { padding:10px 14px; border-bottom:1px solid var(--border); display:flex; align-items:center; justify-content:space-between; }
.rp-panel-title { font-family:'IBM Plex Mono',monospace; font-size:10px; letter-spacing:0.12em; text-transform:uppercase; color:var(--txt2); font-weight:600; }
.rp-panel-body { padding:14px; }
.rp-section { font-family:'IBM Plex Mono',monospace; font-size:10px; letter-spacing:0.18em; text-transform:uppercase; color:var(--txt3); margin:20px 0 12px; padding-bottom:8px; border-bottom:1px solid var(--border); display:flex; align-items:center; gap:10px; }
.rp-section span { color:var(--txt2); }
.rp-regime { background:linear-gradient(135deg,#0d1e35 0%,#0a1628 100%); border:1px solid var(--bord2); border-radius:10px; padding:22px 24px; margin-bottom:18px; position:relative; overflow:hidden; animation:fadeUp 0.4s ease both; }
@keyframes fadeUp { from{opacity:0;transform:translateY(10px)} to{opacity:1;transform:translateY(0)} }
.rp-regime-eyebrow { font-family:'IBM Plex Mono',monospace; font-size:9px; letter-spacing:0.18em; text-transform:uppercase; color:var(--txt3); margin-bottom:4px; }
...
.rp-regime-statement { font-family:'Crimson Pro',Georgia,serif; font-size:15px; font-style:italic; color:var(--txt2); line-height:1.7; padding-left:14px; margin-bottom:14px; }
.rp-flags { display:flex; gap:6px; flex-wrap:wrap; }
.rp-chips { display:flex; gap:10px; flex-wrap:wrap; margin-bottom:16px; }
.rp-chip { background:rgba(0,0,0,0.35); border:1px solid var(--bord2); border-radius:8px; padding:10px 14px; text-align:center; min-width:80px; }
.rp-chip-lbl { font-family:'IBM Plex Mono',monospace; font-size:9px; letter-spacing:0.1em; color:var(--txt3); text-transform:uppercase; margin-bottom:3px; }
.rp-chip-val { font-family:'Bebas Neue',sans-serif; font-size:24px; letter-spacing:0.04em; line-height:1; }
.rp-chip-sub { font-family:'IBM Plex Mono',monospace; font-size:9px; color:var(--txt3); margin-top:2px; }
...
.mc { background:var(--bg4); border:1px solid var(--border); border-radius:6px; padding:12px 13px; }
.mc-lbl { font-family:'IBM Plex Mono',monospace; font-size:9px; letter-spacing:0.1em; text-transform:uppercase; color:var(--txt3); margin-bottom:5px; }
...
.live-dot { display:flex; align-items:center; gap:6px; font-family:'IBM Plex Mono',monospace; font-size:10px; color:var(--green2); letter-spacing:0.08em; }
.live-dot::before { content:''; width:7px; height:7px; background:var(--green2); border-radius:50%; animation:pulse 2s infinite; }
@keyframes pulse { 0%,100%{opacity:1;transform:scale(1)} 50%{opacity:0.5;transform:scale(0.85)} }
.disclaimer { background:rgba(245,158,11,0.05); border:1px solid rgba(245,158,11,0.15); border-radius:6px; padding:10px 14px; margin-bottom:18px; font-family:'IBM Plex Mono',monospace; font-size:9.5px; color:var(--txt3); line-height:1.6; }
.disclaimer strong { color:var(--amber2); }
.rp-topbar { background:var(--bg2); border-bottom:1px solid var(--border); padding:13px 24px; display:flex; align-items:center; justify-content:space-between; margin-bottom:0; }
...
.alpha-row { display:flex; align-items:center; gap:8px; margin-top:10px; padding-top:10px; border-top:1px solid var(--border); }
...
.alpha-badge { font-family:'IBM Plex Mono',monospace; font-size:9px; background:rgba(16,185,129,0.12); border:1px solid rgba(16,185,129,0.25); color:var(--green2); padding:2px 8px; border-radius:3px; letter-spacing:0.05em; }
...
.sb-user { font-family:'IBM Plex Mono',monospace; font-size:9px; color:var(--txt3); padding:10px 18px 0; }
.sb-user span { color:var(--blue2); }
.sb-disclaimer { font-family:'IBM Plex Mono',monospace; font-size:8.5px; color:var(--txt3); line-height:1.6; margin-top:16px; padding-top:12px; border-top:1px solid var(--border); }
